                                        ...
                                        <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input min="0" value="0" name="gia_sp" class="form-control" type="number" />
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label for="">Giá khuyến mãi</label>
                                                            <input min="0" value="0" name="gia_km" class="form-control" type="number" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-2">
                                                <div class="form-group">
                                                    ...
                                                    <input min="1" value="1" name="so_luong" class="form-control" type="number"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
